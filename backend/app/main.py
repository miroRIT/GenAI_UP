...
from app.routes import alerts, analytics, auth, chat, demo, disaster_risk, districts, health, jobs, monitoring, observations, overview, providers, recommendations, upload, wards
